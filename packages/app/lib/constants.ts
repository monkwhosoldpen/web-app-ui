...
export const DEFAULT_PROFILE_PIC =
  "https://via.placeholder.com/600x400/1DA1F2/000000?text=goatsconnect&font=roboto";
...
export const HIDE_MOBILE_WEB_FOOTER_SCREENS = ["/groups/[channelId]",];
export const DARK_THEME_PATHNAMES = ["/"];
