...
export const EditProfile = () => {
  ...
  return (
    <>
      <>
        <View tw="w-full flex-1 my-0 md:my-8">
          <>
            <Controller
              control={control}
              name="coverPicture"
            ...
            <View tw="-mt-12 px-4">
              ...
              <View tw="pt-6">
                ...
                <View tw="mt-4 flex-row overflow-x-hidden">
                  <Pressable
                    tw={`mr-2 w-1/2 flex-1 ${isVerified && defaultValues.name !== ""
                      ? "opacity-60"
                      : "opacity-100"
                      }`}
                    onPress={() => {
                  ...
                  <Pressable
                    tw={`ml-2 w-1/2 flex-1 ${isVerified ? "opacity-60" : "opacity-100"
                      }`}
                    onPress={() => {
            ...
            <View tw="ios:mb-4 p-4 my-2 mb-4">
              <Button
      ...
      <MediaCropper
        ...
        title={`Crop your ${currentCropField === "coverPicture" ? "cover" : "profile"
          } picture`}
