  ...
  useEffect(() => {
    const fetchMessages = async () => {
      ...
      if (error) {
        ...
        const messages_formatted = formatMessages(data);
        setMessages(formatMessages(messages_formatted) as any[]);
        updateMessageCounts(formatMessages(messages_formatted) as any[]);
      }
    };
      ...
      .on(
        ...
        (payload) => {
          ...
          setMessages((prevMessages) => {
            const newMessages = [...prevMessages, ...formatMessages([newMessage])];
